...
public class AppOrderNegativeTest {
    ...
    public void shouldBeFailedIncorrectNameInput() {
        ...
        driver.findElement(By.xpath("//span[@data-test-id='phone']//input")).sendKeys("+79035045775");
    ...
    public void shouldBeFailedEmptyNameInput() {
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79035045775");
    ...
    public void shouldBeFailedIncorrectPhoneInput() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Сидоров Петрович Иван");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79105554");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.cssSelector("button.button")).click();
